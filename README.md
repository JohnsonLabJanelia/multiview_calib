...
Assume the config.json is in the folder calib_dataset. For instance, 
```
export calib_dataset=/nfs/exports/ratlv/calibration/2025_03_24
```
...
```
python charuco_intrinsics.py -r $calib_dataset
```
...
2. Format data 
```
python format_for_calibration.py -r $calib_dataset
```
...
```
python compute_relative_poses.py -r $calib_dataset
```
...
```
python concatenate_relative_poses.py -r $calib_dataset
```
5. Bundle adjustment:
...
```
python bundle_adjustment.py -r $calib_dataset
```
...
```
python global_registration.py -r $calib_dataset
```
...
```
python 17cams.py -i $calib_dataset/output/global_registration/rig_space 
```
